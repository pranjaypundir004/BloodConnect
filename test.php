        ...
        <tr>
            <td align='center' bgcolor='#ffffff'>
                <table width='600' border='0' cellspacing='0' cellpadding='0'>
                    <tr>
                        <td align='center' style='font-size: 24px; font-weight: bold; color: #333333; padding: 20px 0;'>Login Notification</td>
                    </tr>
                    <tr>
                        <td align='left' style='font-size: 16px; color: #555555; padding: 20px; line-height: 24px;'>
                            <p>Dear User,</p>
                            <p>This is to confirm that your Blood Connect account was accessed on:</p>
                            <p><b>Login Time:</b> $loginTime (IST)</p>
                            <p><b>IP Address:</b> $ip</p>
                            <p>If you did not perform this login, please take immediate action to secure your account by resetting your password.</p>
                            <p>Thank you for using Blood Connect.</p>
                            <p>Best regards,</p>
                            <p>bloodconnect98@gmail.com</p>
...
$mail->AltBody = "Dear User,\n\nThis is to confirm that your Blood Connect account was accessed on:\n\nLogin Time: " . date('Y-m-d H:i:s') . "\nIP Address: $ip\n\nIf you did not perform this login, please take immediate action to secure your account by resetting your password. You can do this by visiting the Password Reset page at https://www.bloodconnect.com/reset-password.\n\nThank you for using Blood Connect.\n\nBest regards,\nBlood Connect Team";
