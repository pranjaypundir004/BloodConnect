                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <li class="nav-item mx-lg-4 my-lg-0 my-3">
                                <a class="nav-link" href="donor-list.php">Available Bloods</a>
                            </li>
                            <li class="nav-item mx-lg-4 my-lg-0 my-3">
                            ...
                            <form action="#" method="post"  name="signup" onsubmit="return checkpass();">
                                <div class="form-group">
                                    <label>Full Name</label>
                                     <input type="text" class="form-control" name="fullname" id="fullname_header" placeholder="Full Name">
                                </div>
                                <div class="form-group">
                                    <label>Mobile Number</label>
                                    <input type="text" class="form-control" name="mobileno" id="mobileno_header" required="true" placeholder="Mobile Number" maxlength="10" pattern="[0-9]+">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="age" id="age_header" placeholder="Age" required="">
                                </div>
                                <div class="form-group">
...
<?php }} ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password" id="password_header" required="">
                                </div>
